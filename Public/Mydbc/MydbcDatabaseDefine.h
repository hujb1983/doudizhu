#ifndef __MydbcDatabaseDefine_H_
#define __MydbcDatabaseDefine_H_
...
typedef MydbcQueryResult Query;
typedef void			(*fnCallBackMessage)( char * szMessage );
typedef void			(*fnCallBackQueryResult)( DWORD dwIndex, MydbcQueryResult * pData );



struct MydbcDatabaseDesc
{
