...
UtilityIni::UtilityIni(const char* iniFile) 
{ 
...
UtilityIni::~UtilityIni() 
{ 
} 

void UtilityIni::Update() 
{ 
	WriteIni(ini_file_name_.c_str()); 
} 

const char* UtilityIni::GetString(const char* sect, const char* key, const char* defaultValue) 
{ 
	string mapkey = sect; 
	mapkey += MIDDLESTRING; 
	mapkey += key; 
...
void UtilityIni::SetString(const char* sect, const char* key, const char* value) 
{ 
	string mapkey = sect; 
	mapkey += MIDDLESTRING; 
	mapkey += key; 
...
int UtilityIni::GetInteger(const char* sect, const char* key, int iValue ) 
{ 
...
void UtilityIni::SetInteger(const char* sect, const char* key, int iValue) 
{ 
	char szValue[25] = {0}; 
...
double UtilityIni::GetDouble(const char* sect, const char* key, double dValue ) 
{ 
	const char *value = GetString(sect, key, NULL); 
	if (NULL == value) 
	{ 
...
void UtilityIni::SetDouble(const char* sect, const char* key, double dValue) 
{ 
	char szValue[25] = {0}; 
...
bool UtilityIni::GetBool(const char* sect, const char* key, bool bValue ) 
{ 
	const char *value = GetString(sect, key, NULL); 
	if (NULL == value) 
	{ 
...
void UtilityIni::SetBool(const char* sect, const char* key, bool bValue) 
{ 
	char szValue[2] = {0}; 
	szValue[0] = '0'; 
...
void UtilityIni::DeleteKey(const char* sect, const char* key) 
{ 
	string mapkey = sect; 
	mapkey += MIDDLESTRING; 
	mapkey += key; 
...
void UtilityIni::DeleteSession(const char* sect) 
{ 
	strMapIt it; 
...
bool UtilityIni::OpenIni(const char* iniFile) 
{ 
...
bool UtilityIni::WriteIni(const char* iniFile) 
{ 
	if (ini_map_.empty()) 
	{ 
		return false; 
