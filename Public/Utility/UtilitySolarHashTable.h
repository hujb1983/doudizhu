#ifndef _UtilitySolarHashTable_H_
#define _UtilitySolarHashTable_H_
#include <UtilityDefine.h>
#include <UtilityMemoryFactory.h>

template <class T, class KeyType=DWORD >
class UtilitySolarHashTable
{	
	class HashBucket;
...
protected:
	...
	// memorypool
	UtilityMemoryFactory<HashBucket>	* m_pHashBucketPool;
	UtilityMemoryFactory<HashList>		* m_pHashListPool;

public:

	UtilitySolarHashTable()
	{
		m_dwDataNum			= 0;
		m_dwMaxBucketNum	= 0;
	...
	UtilitySolarHashTable( DWORD dwMaxBucketNum )
	{
		m_dwDataNum			= 0;
		m_dwMaxBucketNum	= 0;
		m_ppBucketTable		= NULL;
	...
	BOOL				Initialize(DWORD dwMaxBucketNum)
	{
		...
		m_pHashBucketPool	= new UtilityMemoryFactory<HashBucket>;
		m_pHashListPool		= new UtilityMemoryFactory<HashList>;
