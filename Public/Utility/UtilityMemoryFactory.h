#ifndef _UtilityMemoryFactory_H_
#define _UtilityMemoryFactory_H_
...
template <class Type>
class UtilityMemoryFactory
{
public:
	UtilityMemoryFactory()
		:	m_pBandHead( NULL ),
			m_pFreeBand( NULL ),
			m_dwPoolExtendSize( 0 )
	{	}
	
	virtual ~UtilityMemoryFactory()
	{
		Release();
	}
...
#endif //end _UtilityMemoryFactory_H_
